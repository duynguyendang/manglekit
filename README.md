...
| Runnable examples (23 demos under six domain folders — incl. `skill_learning`, `learn_from_code`, and `fixed_choice_router`) | [manglekit-examples](https://github.com/duynguyendang/manglekit-examples) |
